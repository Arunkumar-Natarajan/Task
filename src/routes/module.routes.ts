...
router
  .route("/group/update/permission/:permissionId")
  .put(moduleController.removePermission);
router
  .route("/group/delete/module/:permissionId")
  .delete(moduleController.deleteModuleFromGrop);
